...
impl ConfigBuilder {
    ...
    pub fn with_network_silence_delay(&mut self, delay: u64) -> &mut Self {
        self.config.network_silence_delay = delay;
        self
    }

    pub fn with_minimum_sha3_target_difficulty(&mut self, difficulty: u64) -> &mut Self {
        self.config.minimum_sha3_target_difficulty = Some(difficulty);
        self
    }
